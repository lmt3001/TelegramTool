...
class Secp256k1PublicKey {
   ...
   */
  equals(publicKey) {
    return (0, import_publickey.bytesEqual)(this.toBytes(), publicKey.toBytes());
  }
  /**
  ...
  toSuiAddress() {
    ...
    tmp.set([import_signature.SIGNATURE_SCHEME_TO_FLAG["Secp256k1"]]);
    tmp.set(this.toBytes(), 1);
    return (0, import_types.normalizeSuiAddress)(
      (0, import_utils.bytesToHex)((0, import_blake2b.blake2b)(tmp, { dkLen: 32 })).slice(0, import_types.SUI_ADDRESS_LENGTH * 2)
    );
  }
  /**
   * Return the Sui address associated with this Secp256k1 public key
   */
  flag() {
    return import_signature.SIGNATURE_SCHEME_TO_FLAG["Secp256k1"];
  }
}
