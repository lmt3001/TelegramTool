...
const RESOLVED_SUI_ID = {
  address: import_types.SUI_FRAMEWORK_ADDRESS,
  module: import_types.OBJECT_MODULE_NAME,
  name: import_types.ID_STRUCT_NAME
};
const RESOLVED_ASCII_STR = {
  address: import_types.MOVE_STDLIB_ADDRESS,
...
function getPureSerializationType(normalizedType, argVal) {
  if (typeof normalizedType === "string" && allowedTypes.includes(normalizedType)) {
    if (normalizedType in ["U8", "U16", "U32", "U64", "U128", "U256"]) {
      ...
      if (argVal && !(0, import_types.isValidSuiAddress)(argVal)) {
