    ...
    return {
      Object: {
        ImmOrOwned: {
          digest,
          version,
          objectId: (0, import_types.normalizeSuiAddress)(objectId)
        }
      }
    };
  },
...
function getIdFromCallArg(arg) {
  if (typeof arg === "string") {
    return (0, import_types.normalizeSuiAddress)(arg);
  }
  if ("ImmOrOwned" in arg.Object) {
    return (0, import_types.normalizeSuiAddress)(arg.Object.ImmOrOwned.objectId);
  }
  return (0, import_types.normalizeSuiAddress)(arg.Object.Shared.objectId);
}
