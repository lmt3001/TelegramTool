...
const MovePackageContent = (0, import_superstruct.record)((0, import_superstruct.string)(), (0, import_superstruct.string)());
...
const SuiObjectResponseError = (0, import_superstruct.object)({
  ...
  object_id: (0, import_superstruct.optional)(import_common.ObjectId),
  parent_object_id: (0, import_superstruct.optional)(import_common.ObjectId),
  version: (0, import_superstruct.optional)((0, import_superstruct.number)()),
  digest: (0, import_superstruct.optional)(ObjectDigest)
});
const DisplayFieldsResponse = (0, import_superstruct.object)({
  data: (0, import_superstruct.nullable)((0, import_superstruct.record)((0, import_superstruct.string)(), (0, import_superstruct.string)())),
  error: (0, import_superstruct.nullable)(SuiObjectResponseError)
});
...
const SuiObjectData = (0, import_superstruct.object)({
  ...
  version: import_common.SequenceNumber,
  digest: ObjectDigest,
  /**
   * Type of the object, default to be undefined unless SuiObjectDataOptions.showType is set to true
   */
  type: (0, import_superstruct.optional)((0, import_superstruct.string)()),
  /**
   * Move object content or package content, default to be undefined unless SuiObjectDataOptions.showContent is set to true
   */
  content: (0, import_superstruct.optional)(SuiParsedData),
  /**
   * Move object content or package content in BCS bytes, default to be undefined unless SuiObjectDataOptions.showBcs is set to true
   */
  bcs: (0, import_superstruct.optional)(SuiRawData),
  /**
   * The owner of this object. Default to be undefined unless SuiObjectDataOptions.showOwner is set to true
   */
  owner: (0, import_superstruct.optional)(import_common.ObjectOwner),
  /**
   * The digest of the transaction that created or last mutated this object.
   * Default to be undefined unless SuiObjectDataOptions.showPreviousTransaction is set to true
   */
  previousTransaction: (0, import_superstruct.optional)(import_common.TransactionDigest),
  /**
   ...
   */
  storageRebate: (0, import_superstruct.optional)((0, import_superstruct.string)()),
  /**
   * Display metadata for this object, default to be undefined unless SuiObjectDataOptions.showDisplay is set to true
   * This can also be None if the struct type does not have Display defined
   * See more details in https://forums.sui.io/t/nft-object-display-proposal/4872
   */
  display: (0, import_superstruct.optional)(DisplayFieldsBackwardCompatibleResponse)
});
const SuiObjectDataOptions = (0, import_superstruct.object)({
  /* Whether to fetch the object type, default to be true */
  showType: (0, import_superstruct.optional)((0, import_superstruct.boolean)()),
  /* Whether to fetch the object content, default to be false */
  showContent: (0, import_superstruct.optional)((0, import_superstruct.boolean)()),
  /* Whether to fetch the object content in BCS bytes, default to be false */
  showBcs: (0, import_superstruct.optional)((0, import_superstruct.boolean)()),
  /* Whether to fetch the object owner, default to be false */
  showOwner: (0, import_superstruct.optional)((0, import_superstruct.boolean)()),
  /* Whether to fetch the previous transaction digest, default to be false */
  showPreviousTransaction: (0, import_superstruct.optional)((0, import_superstruct.boolean)()),
  /* Whether to fetch the storage rebate, default to be false */
  showStorageRebate: (0, import_superstruct.optional)((0, import_superstruct.boolean)()),
  /* Whether to fetch the display metadata, default to be false */
  showDisplay: (0, import_superstruct.optional)((0, import_superstruct.boolean)())
});
...
const SuiObjectResponse = (0, import_superstruct.object)({
  data: (0, import_superstruct.optional)(SuiObjectData),
  error: (0, import_superstruct.optional)(SuiObjectResponseError)
});
...
const PaginatedObjectsResponse = (0, import_superstruct.object)({
  ...
  nextCursor: (0, import_superstruct.union)([(0, import_superstruct.nullable)(import_common.ObjectId), (0, import_superstruct.nullable)(CheckpointedObjectId)]),
...
const ObjectRead = (0, import_superstruct.union)([
  ...
  (0, import_superstruct.object)({
    details: import_common.ObjectId,
  ...
  (0, import_superstruct.object)({
    details: (0, import_superstruct.tuple)([import_common.ObjectId, (0, import_superstruct.number)()]),
  ...
  (0, import_superstruct.object)({
    details: (0, import_superstruct.object)({
      ...
      object_id: import_common.ObjectId
    }),
