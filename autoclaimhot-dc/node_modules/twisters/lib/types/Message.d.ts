export declare type NoMeta = undefined;
export interface Message<Meta = NoMeta> {
     ...
     */
    render: (message: Message<Meta>, spinnerFrame: string | null, name: string) => string | null;
}
export declare type MessageMap<Meta = NoMeta> = Map<string, Message<Meta>>;
