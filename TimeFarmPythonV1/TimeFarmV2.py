    ...
    async with aiohttp.ClientSession() as session:
        while True:
            ...
            for query_id in query_ids:
                ...
                # Decode query_id to get username and login token
                ...
                if account_info:
                    try:
                        ...
                        print(f"{Fore.GREEN+Style.BRIGHT}User: {first_name} {last_name}  Balance: {formatted_balance}")
                    except KeyError:
            ...
            # Add a random delay between 500 to 800 seconds before next iteration
